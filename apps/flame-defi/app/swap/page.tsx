...
import { ActionButton, TokenSelector, SettingsPopover, TxnInfo } from "@repo/ui/components";
	...
	return (
		<section className="min-h-[calc(100vh-85px-96px)] flex flex-col mt-[100px]">
			<div className="max-w-[550px] w-full mx-auto rounded-2xl p-4 sm:p-4 md:p-8 lg:p-12 border border-solid border-transparent bg-radial-dark shadow-[inset_1px_1px_1px_-1px_hsla(0,0%,100%,0.5)]">
				...
				<div onKeyDown={() => null} onClick={() => setInputSelected(TOKEN_INPUTS.TOKEN_ONE)} className={`flex flex-col rounded-md p-2 transition duration-300 border border-solid border-border hover:border-grey-light ${
				...
				<div onKeyDown={() => null} onClick={() => setInputSelected(TOKEN_INPUTS.TOKEN_TWO)} className={`flex flex-col rounded-md p-2 transition duration-300 border border-solid border-border hover:border-grey-light ${
