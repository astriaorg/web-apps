...
describe("Utility Functions", () => {
  describe("formatBalance", () => {
    it("should correctly format the balance", () => {
      ...
      expect(formatBalance("123456000000000000")).toBe("0.123456");

      expect(formatBalance("100000000000", 6)).toBe("100000");
      expect(formatBalance("150000000000", 6)).toBe("150000");
      expect(formatBalance("123456000000", 6)).toBe("123456");
