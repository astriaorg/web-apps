...
export type VaultByAddressQuery = { __typename?: 'Query', vaultByAddress: { __typename?: 'Vault', address: any, name: string, symbol: string, asset: { __typename?: 'Asset', logoURI?: string | null, name: string, symbol: string }, state?: { __typename?: 'VaultState', netApy?: number | null, guardian: any, fee: number } | null, metadata?: { __typename?: 'VaultMetadata', description: string, curators: Array<{ __typename?: 'VaultMetadataCurator', image: string, name: string }> } | null } };
