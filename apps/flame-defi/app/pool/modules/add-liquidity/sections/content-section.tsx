  ...
  const handleInputChange = useCallback(
    (value: string, id: POOL_INPUT_ID, coinDecimals?: number) => {
      ...
      if (id === POOL_INPUT_ID.INPUT_ZERO) {
        setInput0(value);
        setInput1(getTokenCalculatedTokenValue(value, id, coinDecimals, currentPrice));
      } else {
        setInput1(value);
        setInput0(getTokenCalculatedTokenValue(value, id, coinDecimals, currentPrice));
      }
    },
    [currentPrice, setErrorText],
  );
